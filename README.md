...
![This image shows the GUI of musiccharts, it contains buttons to scrap the top 100 lists of different genres as a csv file](window.png "The GUI of musiccharts")
